...
// ]
 ...
 useEffect(()=>{
  ...
  async function fetchdata(){
    let productsdata=await axios.get("http://localhost:8003/products") // 2sec  productsdata={data:[{},{},{}]}
   let ecps=productsdata.data// 0.0000000001 sec ecps=[{},{},{},{}]
    setProducts(ecps)// products= ecps
